...
public class AccountUser {
    ...
    public AccountUser(double accountNumber, double balance, String firstName, String lastName, String email, String phoneNumber) {
    ...
    public String setAccountNumber(double accountNumber) {
        try {
            this.accountNumber = accountNumber;
            return ("Account number updated Successfully");
